        ...
        <div className={classes['container']}>
            ...
            <div className={classes['container_div']}>
                ...
                <div className={classes['text_div']}>
                    ...
                    <p>Պատրաստում ենք վաճառող լենդինգ էջեր ապրանքների և ծառայությունների սահմանափակ քանակությամբ: Կայքի այս տեսակները նախատեսված են 1-5 ապրանքի կամ ծառայության ակտիվ գովազդի միջոցով վաճառելու, ակցիաներ գովազդելու, ինֆորմացիա տեղադրելու համար: Լենդինգները բաղկացած են մեկ էջից, որտեղ տրվում են գնորդների հիմնական հարցերի պատասխանները, նշվում են ապրանքի առավելությունները: </p>
                </div>
